...
# -*- coding: utf-8 -*-
"""
🎯 МАКСИМАЛЬНО НАДЕЖНЫЙ СИНХРОНИЗИРОВАННЫЙ ОПТИМИЗАТОР С УЛУЧШЕННОЙ СИСТЕМОЙ БАЛЛОВ
...
✅ 🆕 ОПТИМИЗАЦИЯ EMA ПЕРИОДОВ для максимальной надежности!
...
def suggest_parameters_anti_overfitting(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    return {
        ...
        # === EMA ПЕРИОДЫ (МАКСИМАЛЬНАЯ НАДЕЖНОСТЬ) ===
        'MA_FAST': trial.suggest_int('MA_FAST', 6, 28, step=2),  # Точный поиск для качества
        'MA_SLOW': trial.suggest_int('MA_SLOW', 12, 60, step=2),   # Точный поиск для качества
    }
...
if __name__ == '__main__':
    print("🎯 МАКСИМАЛЬНО НАДЕЖНАЯ ОПТИМИЗАЦИЯ (2500 TRIALS) ГОТОВА К ЗАПУСКУ!")
    ...
    print("  • 🆕 ОПТИМИЗАЦИЯ EMA ПЕРИОДОВ: MA_FAST (5-15), MA_SLOW (15-35)")
    ...
    print("  • MedianPruner: 120 startup trials, 20 warmup steps")
