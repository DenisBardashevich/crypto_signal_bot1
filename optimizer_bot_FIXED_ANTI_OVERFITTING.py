...
def optimize_filters_anti_overfitting():
    """🎯 МАКСИМАЛЬНО ТЩАТЕЛЬНАЯ ОПТИМИЗАЦИЯ ДЛЯ 15М ТОРГОВЛИ (10000 TRIALS)"""
    global GLOBAL_ALL_SYMBOLS
    
    print("🎯 ЗАПУСК МАКСИМАЛЬНО ТЩАТЕЛЬНОЙ ОПТИМИЗАЦИИ (10000 КОМБИНАЦИЙ)")
    print("="*80)
    ...
    N_TRIALS = 5000  # ОПТИМИЗИРОВАНО: 10000 попыток для максимально тщательной оптимизации
    ...
    study = optuna.create_study(
        ...
        sampler=optuna.samplers.TPESampler(
            seed=42,
            n_startup_trials=1000,          # ОПТИМИЗИРОВАНО: 1000/10000 = 10% для тщательного разогрева
            n_ei_candidates=50,             # ОПТИМИЗИРОВАНО: 50 кандидатов для 10000 trials
    ...
    print(f"\n🔥 НАЧИНАЕМ МАКСИМАЛЬНО ТЩАТЕЛЬНУЮ ОПТИМИЗАЦИЮ (10000 КОМБИНАЦИЙ)...")
