...
# --- Объём ---
MIN_VOLUME_USDT = 500_000  # минимальный объём торгов за 24ч (USDT)
...
# --- Take Profit ---
TP_MIN = 0.01   # минимум 2%
TP_MAX = 0.25   # максимум 25%
TP_ATR_MULT = 2.5

# --- Stop Loss ---
SL_MIN = 0.01   # минимум 2%
...
MAX_SPREAD_PCT = 0.015  # максимальный спред для более частых входов
VOLUME_SPIKE_MULT = 1.05  # множитель для объёма (1.1 = объём должен быть выше на 10% от среднего)
