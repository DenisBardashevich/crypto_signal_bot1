...
MIN_COMPOSITE_SCORE = 7.0  # Снижено с 7.5, т.к. новая логика более строгая
...
WEIGHT_RSI = 1.2       # Повышен с 1.0, т.к. теперь это индикатор подтверждения
WEIGHT_MACD = 1.5      # Повышен с 1.4 для акцента на моментум
WEIGHT_BB = 0.8        # Понижен с 1.3, чтобы уменьшить влияние "ловли ножей"
WEIGHT_VWAP = 1.0      # Понижен с 1.6, чтобы уменьшить влияние "ловли ножей"
WEIGHT_VOLUME = 1.1    # без изменений
WEIGHT_ADX = 1.3       # без изменений
