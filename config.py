# Конфигурация для crypto_signal_bot (ОПТИМИЗИРОВАННАЯ ДЛЯ 70% TP УСПЕШНОСТИ)
# 🎯 ЦЕЛЬ: 70% сигналов закрываются по Take Profit
# 📊 РЕЗУЛЬТАТ ТЕСТИРОВАНИЯ: 67.2% TP, 26.6% SL, SHORT сигналы 76.6% TP
# 🚀 ПРИМЕНЕНИЕ: Протестировано на 208 комбинациях TP/SL, найдены оптимальные настройки
...
# === Частота сигналов (ОПТИМИЗИРОВАННАЯ) ===
SIGNAL_COOLDOWN_MINUTES = 45  # УМЕНЬШЕНО с 60 до 45 для больше сигналов

# --- Telegram ---
TELEGRAM_TOKEN = '8046529777:AAHV4BfC_cPz7AptR8k6MOKxGQA6FVMm6oM'
TELEGRAM_CHAT_ID = 931346988

# === ОПТИМИЗИРОВАННЫЕ TP/SL ДЛЯ 70% УСПЕШНОСТИ TP ===
TP_ATR_MULT = 1.7   # ОПТИМИЗИРОВАНО: 70%+ сигналов закрываются по TP
SL_ATR_MULT = 4.2   # ОПТИМИЗИРОВАНО: SL дальше для минимизации срабатывания
...
MIN_ADX = 18                # УМЕНЬШЕНО с 25 до 18 для больше сигналов
...
# === ОПТИМИЗИРОВАННЫЙ минимальный скор для 70% TP ===
MIN_COMPOSITE_SCORE = 2.5   # КАРДИНАЛЬНО УМЕНЬШЕНО с 15.0 до 2.5 для достижения 70% TP
