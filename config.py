...
MIN_VOLUME_USDT = 800_000  # снижено с 1.2М до 800К для большего количества пар
...
# --- Take Profit и Stop Loss (СБАЛАНСИРОВАННЫЕ НАСТРОЙКИ) ---
TP_ATR_MULT = 1.8   # УМЕНЬШЕНО с 3.0 до 1.8 - более реалистичный TP
SL_ATR_MULT = 1.2   # УВЕЛИЧЕНО с 1.0 до 1.2 - больше пространства для SL
TP_MIN = 0.012      # уменьшено с 0.015 до 0.012 - более близкие цели
TP_MAX = 0.025      # КРИТИЧНО уменьшено с 0.040 до 0.025
SL_MIN = 0.008      # увеличено с 0.006 до 0.008 - больше пространства
SL_MAX = 0.018      # увеличено с 0.015 до 0.018
...
# --- МЯГКИЕ фильтры сигналов (для тестирования) ---
MIN_ADX = 12          # снижено с 18 до 12 - очень мягкое требование к тренду
MAX_SPREAD_PCT = 0.008  # увеличено с 0.005 до 0.008
...
# УЛУЧШЕННЫЙ минимальный скор для качественных сигналов
MIN_COMPOSITE_SCORE = 6.0  # повышено с 5.0 до 6.0 - только надежные сигналы

# --- Пороги триггеров (МЯГКИЕ НАСТРОЙКИ) ---
MIN_TRIGGERS_ACTIVE_HOURS = 0.4   # активные часы - очень мягко
MIN_TRIGGERS_INACTIVE_HOURS = 0.5  # неактивные часы - тоже мягко
...
# При высокой волатильности - умеренные фильтры
HIGH_VOL_ADX_MIN = 25  # снижено с 40 до 25
HIGH_VOL_RSI_EXTREME = 15  # смягчено с 10 до 15

# При низкой волатильности - очень мягкие фильтры
LOW_VOL_ADX_MIN = 10  # снижено с 15 до 10
...
SHORT_BOOST_MULTIPLIER = 1.8  # увеличено с 1.5 до 1.8 - SHORT работают отлично!
LONG_PENALTY_IN_DOWNTREND = 0.4  # КРИТИЧНО усилен штраф с 0.6 до 0.4
