...
# КРИТИЧНО: Синхронизация с оптимизатором для получения 100 сигналов в день
MIN_COMPOSITE_SCORE = 2.0  # БЫЛО 2.5 - ИСПРАВЛЕНО! Используем точно как в оптимизаторе
MIN_SCORE = 2.0  # ЛУЧШИЕ ПАРАМЕТРЫ - синхронизировано с MIN_COMPOSITE_SCORE
MIN_ADX = 35  # ЛУЧШИЕ ПАРАМЕТРЫ - точно как в оптимизаторе
RSI_MIN = 44  # ЛУЧШИЕ ПАРАМЕТРЫ - точно как в оптимизаторе
RSI_MAX = 62  # ЛУЧШИЕ ПАРАМЕТРЫ - точно как в оптимизаторе
...
MIN_VOLUME_USDT = 0.05  # ИСПРАВЛЕНО: очень низкие требования для тестирования
...
MIN_BB_WIDTH = 0.0366  # ЛУЧШИЕ ПАРАМЕТРЫ - синхронизировано
...
MAX_SPREAD_PCT = 0.047  # ЛУЧШИЕ ПАРАМЕТРЫ - синхронизировано
...
MIN_TRIGGERS_ACTIVE_HOURS = 0.17  # ЛУЧШИЕ ПАРАМЕТРЫ - синхронизировано
