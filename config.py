...
MIN_ADX = 15                # увеличено с 10 до 15 - сильный тренд обязателен
...
MIN_COMPOSITE_SCORE = 7.0   # УВЕЛИЧЕНО с 4.5 до 7.0 - только лучшие сигналы
...
WEIGHT_RSI = 2.5       # увеличено с 1.8
WEIGHT_MACD = 3.0      # увеличено с 2.0 - главный фактор
WEIGHT_BB = 2.2        # увеличено с 1.5
WEIGHT_VWAP = 2.0      # увеличено с 1.2
WEIGHT_VOLUME = 2.5    # увеличено с 1.8
WEIGHT_ADX = 3.5       # увеличено с 2.2 - тренд критичен
